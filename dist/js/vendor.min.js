...
!function(e){e.fn.prognroll=function(o){var i=e.extend({height:5,color:"#50bcb6",custom:!1},o);return this.each(function(){if(e(this).data("prognroll"))return!1;e(this).data("prognroll",!0);var o=e("<span>",{class:"bar"});e("body").prepend(o),o.css({position:"fixed",top:0,left:0,width:0,height:i.height,backgroundColor:i.color,zIndex:1039}),!1===i.custom?e(window).scroll(function(o){o.preventDefault();var t=e(window).scrollTop(),r=e(window).outerHeight(),n=t/(e(document).height()-r)*100;e(".bar").css("width",n+"%")}):e(this).scroll(function(o){o.preventDefault();var t=e(this).scrollTop(),r=e(this).outerHeight(),n=t/(e(this).prop("scrollHeight")-r)*100;e(".bar").css("width",n+"%")}),e(window).on("hashchange",function(o){o.preventDefault(),console.log(e(window).scrollTop())}),e(window).trigger("hashchange");var t=e(window).scrollTop(),r=e(window).outerHeight(),n=t/(e("body").outerHeight()-r)*100;e(".bar").css("width",n+"%")})}}(jQuery);
